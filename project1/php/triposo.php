...
//specifying api url with required parameters retrieved from ajax data
	...
	$url='https://www.triposo.com/api/20221011/location.json?countrycode='.$_REQUEST['countrycode'].'&count=50&account=UZY7IT9G&token=2cxx7tc4qvfgg0el3acreky49t6fd4tk';
