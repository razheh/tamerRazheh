...
function err(){
    ...
    option.innerHTML = "United Kingdom";
            ...
            const selectedCountry = countryList.find( countryObj => 
               ...
               const borderCountry = storeList.find( countryObj => 
                countryObj.id === "GBR");
                borderCountry;
                console.log(borderCountry);
                const countrysLayer = L.geoJSON(borderCountry, {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    cdata.forEach((data)=>
                    {
                        ...
                        const mlayer=L.marker([lat,lng],{icon:cityIcon});
