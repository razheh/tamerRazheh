...
//window.addEventListener('load'      , getallemployees(),getdepartments(),getlocations()  );
                      ...
                      function getallemployees(){
                        ...
                        addbutton.dataset.bsTarget="#addemployeemodal";
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                                ...
                                                success: function(result) {
                                                    ...
                                                    if (result.status.name == "ok") {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            $('#AppContainer').load("views/employees.html")
                                                            window.addEventListener('load',getallemployees());
                                    ...
                                    employees.forEach((employee) => {
                                        ...
                                        //p6.innerText=editbuttonemployee;
                                        ...
                                        tr.appendChild(p5);
                                        tr.appendChild(p6);
                                        p6.appendChild(editbuttonemployee);
                                        editbuttonemployee.appendChild(icon);
                        ...
                        function getlocations(){
                            const addbutton=document.querySelector(".addbutton");
                        addbutton.innerText="Add Location";
                        addbutton.dataset.bsTarget="#addlocationmodal";
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    ...
                                    locations.forEach((location) => {
                                        ...
                                        tr.appendChild(p2);
                                        p2.appendChild(locationeditbutton);
                                        locationeditbutton.appendChild(icon);
                                                ...
                                                success: function(result) {
                                                    ...
                                                    if (result.status.name == "ok") {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            $('#AppContainer').load("views/locations.html")
                                                            window.addEventListener('load',getlocations());
                                                            //  getlocations();
                        ...
                        function getdepartments(){
                            const addbutton=document.querySelector(".addbutton");
                            addbutton.innerText="Add Department";
                            addbutton.dataset.bsTarget="#adddepartmentmodal";
                            $.ajax({
                                url: "php/getAllLocations.php",
                                type: 'GET',
                                dataType: 'json',
                                                ...
                                                success: function(result) {
                                                    ...
                                                    if (result.status.name == "ok") {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            $('#AppContainer').load("views/departments.html")
                                                            window.addEventListener('load',getdepartments());
                                                            //  getdepartments();
